...
def main(args):
  ...
  for year in years:
    if JECvar!="":
        indir      = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/%s%s%s_%s/"%(ULtag,year,preVFP,JECvar)
        #indir      = "/scratch/pbaertsc/bbh/samples/%s%s%s_%s/"%(ULtag,year,preVFP,JECvar)
        samplesdir = args.outdir if args.outdir else "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,JECvar)
    else:
        if tes!="":
            indir      = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/%s%s%s_%s/"%(ULtag,year,preVFP,tes)
            #indir      = "/scratch/pbaertsc/bbh/samples/%s%s%s_%s/"%(ULtag,year,preVFP,tes)
            samplesdir = args.outdir if args.outdir else "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,tes)
        else:
            indir      = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/%s%s%s/"%(ULtag,year,preVFP)
            #indir      = "/scratch/pbaertsc/bbh/samples/%s%s%s/"%(ULtag,year,preVFP)
            samplesdir = args.outdir if args.outdir else "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s"%(ULtag,year,preVFP)
            #samplesdir = args.outdir if args.outdir else "/scratch/pbaertsc/bbh/samples_%s%s%s"%(ULtag,year,preVFP)
    os.chdir(indir)
    ...
    for channel in channels:
      ...
      if not args.haddother or args.make:
        for directory in samplelist:
            ...
            #outdir  = "/work/pbaertsc/bbh/NanoTreeProducer/samples_%s%s%s"%(ULtag,year,preVFP)
            if JECvar!="":
                outdir  = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,JECvar)
                #outdir  = "/scratch/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,JECvar)
            else:
                if tes!="":
                    outdir  = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,tes)
                    #outdir  = "/scratch/pbaertsc/bbh/samples_%s%s%s_%s"%(ULtag,year,preVFP,tes)
                else:
                    outdir  = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_%s%s%s"%(ULtag,year,preVFP)
                    #outdir  = "/scratch/pbaertsc/bbh/samples_%s%s%s"%(ULtag,year,preVFP)
            ...
            if args.make:
                ...
                if os.path.isfile(outfile):
                  if args.force:
                    ...
                    continue
                haddcmd = 'hadd -f -n 10 %s %s'%(outfile,infiles)
                #haddcmd = 'phadd -j 20 -l ERROR -f %s %s'%(outfile,infiles)
                print(haddcmd)
                os.system(haddcmd)
                # CLEAN UP
                if args.cleanup:
      ...
      if year == 2018:
          haddsets = [
                  ('SingleMuon', 'SingleMuon_Run2018ABCD', ['SingleMuon_Run2018A-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018B-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018C-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018D-UL2018_MiniAODv2_NanoAODv9-v1']),
                  ('EGamma', 'EGamma_Run2018ABCD', ['EGamma_Run2018A-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018B-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018C-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018D-UL2018_MiniAODv2_NanoAODv9-v3']),
                  ('MET', 'MET_Run2018ABCD', ['MET_Run2018A-UL2018_MiniAODv2_NanoAODv9-v2','MET_Run2018B-UL2018_MiniAODv2_NanoAODv9-v2','MET_Run2018C-UL2018_MiniAODv2_NanoAODv9-v1','MET_Run2018D-UL2018_MiniAODv2_NanoAODv9-v1']),
                  ('SingleMuon_SingleElectron', 'SingleMuon_SingleElectron_Run2018ABCD', ['SingleMuon_Run2018A-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018B-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018C-UL2018_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2018D-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018A-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018B-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018C-UL2018_MiniAODv2_NanoAODv9-v1','EGamma_Run2018D-UL2018_MiniAODv2_NanoAODv9-v3']),
                  ('TauEmbedding', 'TauEmbedding_MuTau_Run2018ABCD', ['TauEmbedding_data_2018_MuTau_nanoaod_Run2018A','TauEmbedding_data_2018_MuTau_nanoaod_Run2018B','TauEmbedding_data_2018_MuTau_nanoaod_Run2018C','TauEmbedding_data_2018_MuTau_nanoaod_Run2018D']),
                  ('TauEmbedding', 'TauEmbedding_ElTau_Run2018ABCD', ['TauEmbedding_data_2018_ElTau_nanoaod_Run2018A','TauEmbedding_data_2018_ElTau_nanoaod_Run2018B','TauEmbedding_data_2018_ElTau_nanoaod_Run2018C','TauEmbedding_data_2018_ElTau_nanoaod_Run2018D']),
                  ('SingleMuon', 'SingleMuon_Run2018ABCD_HPS', ['SingleMuon_Run2018A-UL2018_HPS','SingleMuon_Run2018BCD-UL2018_HPS','SingleMuon_Run2018RECOV-UL2018_HPS']),
                  ('EGamma', 'EGamma_Run2018ABCD_HPS', ['EGamma_Run2018A-UL2018_HPS','EGamma_Run2018BCD-UL2018_HPS','EGamma_Run2018RECOV-UL2018_HPS']),
              
          ]
      elif year==2017:
          if ULtag=="UL":
              haddsets = [
                  ('SingleMuon', 'SingleMuon_Run2017BCDEF', ['SingleMuon_Run2017B-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017D-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017E-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017F-UL2017_MiniAODv2_NanoAODv9-v1']),
                  ('SingleElectron', 'SingleElectron_Run2017BCDEF', ['SingleElectron_Run2017B-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017D-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017E-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017F-UL2017_MiniAODv2_NanoAODv9-v1']),
                  ('MET', 'MET_Run2017BCDEF', ['MET_Run2017B-UL2017_MiniAODv2_NanoAODv9-v1','MET_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1','MET_Run2017D-UL2017_MiniAODv2_NanoAODv9-v1','MET_Run2017E-UL2017_MiniAODv2_NanoAODv9-v1','MET_Run2017F-UL2017_MiniAODv2_NanoAODv9-v1']),
                  ('SingleMuon_SingleElectron', 'SingleMuon_SingleElectron_Run2017BCDEF', ['SingleMuon_Run2017B-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017D-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017E-UL2017_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2017F-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017B-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017D-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017E-UL2017_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2017F-UL2017_MiniAODv2_NanoAODv9-v1'])]
      elif year==2016:
          if ULtag=="UL":
              haddsets = [
                  ('SingleMuon', 'SingleMuon_Run2016BCDEFGH', ['SingleMuon_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1']),
                  ('SingleElectron', 'SingleElectron_Run2016BCDEFGH', ['SingleElectron_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1']),
                  ('SingleMuon', 'SingleMuon_Run2016FGH', ['SingleMuon_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1']),
                  ('SingleElectron', 'SingleElectron_Run2016FGH', ['SingleElectron_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1']),
                  ('SingleMuon', 'SingleMuon_Run2016BCDEF', ['SingleMuon_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v1']),
                  ('SingleElectron', 'SingleElectron_Run2016BCDEF', ['SingleElectron_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v2']),
                  ('SingleMuon_SingleElectron', 'SingleMuon_SingleElectron_Run2016BCDEFGH', ['SingleMuon_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleMuon_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleMuon_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016C-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016D-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016F-HIPM_UL2016_MiniAODv2_NanoAODv9-v2','SingleElectron_Run2016F-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016G-UL2016_MiniAODv2_NanoAODv9-v1','SingleElectron_Run2016H-UL2016_MiniAODv2_NanoAODv9-v1'])]
          
      if args.haddother:
        if year==2016:
            #workdir = "/work/pbaertsc/bbh/NanoTreeProducer"
            workdir = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/"
            #workdir = "/scratch/pbaertsc/bbh/"
            
            print("hadd UL2016 MC files")
            for sample in list(getMCsamples(year).values()):
                if JECvar=="" and tes=="":
                    ensureDirectory('%s/samples_UL2016_comb'%workdir)
                    haddcmd = 'hadd -f -n 10 %s/samples_UL2016_comb/%s.root %s/samples_UL2016/%s.root %s/samples_UL2016_preVFP/%s.root'%(workdir,sample,workdir,sample,workdir,sample)
                    #haddcmd = 'phadd -j 20 -l ERROR -f %s/samples_UL2016_comb/%s.root %s/samples_UL2016/%s.root %s/samples_UL2016_preVFP/%s.root'%(workdir,sample,workdir,sample,workdir,sample)
                else:
                    if tes!="":
                        ensureDirectory('%s/samples_UL2016_comb_%s'%(workdir,tes)) 
                        haddcmd = 'hadd -f -n 10 %s/samples_UL2016_comb_%s/%s.root %s/samples_UL2016_%s/%s.root %s/samples_UL2016_preVFP_%s/%s.root'%(workdir,tes,sample,workdir,tes,sample,workdir,tes,sample) 
                        #haddcmd = 'phadd -j 20 -l ERROR -f %s/samples_UL2016_comb_%s/%s.root %s/samples_UL2016_%s/%s.root %s/samples_UL2016_preVFP_%s/%s.root'%(workdir,tes,sample,workdir,tes,sample,workdir,tes,sample) 
                    elif JECvar!="":
                        ensureDirectory('%s/samples_UL2016_comb_%s'%(workdir,JECvar))
                        haddcmd = 'hadd -f -n 10 %s/samples_UL2016_comb_%s/%s.root %s/samples_UL2016_%s/%s.root %s/samples_UL2016_preVFP_%s/%s.root'%(workdir,JECvar,sample,workdir,JECvar,sample,workdir,JECvar,sample)
                        #haddcmd = 'phadd -j 20 -l ERROR -f %s/samples_UL2016_comb_%s/%s.root %s/samples_UL2016_%s/%s.root %s/samples_UL2016_preVFP_%s/%s.root'%(workdir,JECvar,sample,workdir,JECvar,sample,workdir,JECvar,sample)
                os.system(haddcmd)
            #if JECvar=="" and tes=="": #for JECvariations no need to copy data
        ...
        for subdir, samplename, sampleset in haddsets:
            ...
            if len(allinfiles)==1:
              ...
              haddcmd = 'hadd -f -n 10 %s %s'%(outfile,' '.join(infiles))
              #haddcmd = 'phadd -j 20 -l ERROR -f %s %s'%(outfile,' '.join(infiles))
              print(haddcmd)
              os.system(haddcmd)
              if year==2016:
                  ...
                  print(copyfiles)
                  os.system(copyfiles)
                  copyfiles =  'cp -f %s/samples_UL2016/%s %s/samples_UL2016_preVFP/%s'%(workdir,outfile.split("/")[-1],workdir,outfile.split("/")[-1])
                  print(copyfiles)
                  os.system(copyfiles)
            else:
