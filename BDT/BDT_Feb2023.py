...
modelname = 'xgbmodel_%s_UL%s_Feb2023.sav'%(channel,year)
...
if args.train:
    ...
    #train_length = signal_train_length
    #test_length = signal_test_length
    ...
    file = open("inputlist_Feb2023.txt","w")
...
if args.predict:
    ...
    file = open("inputlist_Feb2023.txt","r")
