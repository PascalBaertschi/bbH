...
modelname = 'xgbmodel_%s_UL%s_dyfake.sav'%(channel,year)
...
if args.train:
    ...
    file_dy_train = uproot.open("%sBDT_UL%s_%s_train_dy_fake.root"%(rootdir,year,channel))
    ...
    file_dy_test = uproot.open("%sBDT_UL%s_%s_test_dy_fake.root"%(rootdir,year,channel))
