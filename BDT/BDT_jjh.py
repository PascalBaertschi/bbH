...
if NN:
    ...
    outdir = ensureDirectory("/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_UL%s%s%s_BDT_jjh/%s/"%(year,preVFP,sysvar,channel))
...
modelname = 'xgbmodel_%s_UL%s_jjh.sav'%(channel,year)
