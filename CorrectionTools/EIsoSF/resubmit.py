...
def main():
    ...
    for year in years:
      ...
      samplelist = [ ]
      if JECvar!="":
          outdir     = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/EIsoSF/%s%s%s_%s/"%(ULtag,year,preVFP,JECvar)
      else:
          outdir     = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/EIsoSF/%s%s%s/"%(ULtag,year,preVFP)
      ...
      for channel in channels:
        ...
        for directory in samplelist:
            outdir       = "/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples/EIsoSF/%s%s%s/%s"%(ULtag,year,preVFP,directory)
