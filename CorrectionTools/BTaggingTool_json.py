...
path_json = 'CorrectionTools/jsonpog-integration/POG/BTV/'
class BTagWPs:
    ...
    def getSF(self,pt,eta,flavor,flavor_hadron,discriminator,tagged,measurementType,sysType):
        ...
        if measurementType=="shape":
          if self.matchSystoFlavor(sysType,flavor_hadron):
            ...
            SF = self.btvjson["deepJet_%s"%measurementType].evaluate("central", flavor_hadron, abs(eta),pt,discriminator)
        else:
          if flavor_hadron==0:
