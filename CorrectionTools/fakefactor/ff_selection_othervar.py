...
def drawPlots(hists,year,channel,preVFP):
    for sample in getsamples(channel,year,preVFP):
        ...
        for selection_prongjet in selections_prong:
            ...
            hists['H_mass'][sample + '_AR_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection, wt=weight)
            hists['H_mass'][sample + '_ARtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
            hists['H_mass'][sample + '_ARTT_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection_TT, wt=weight)
            hists['H_mass'][sample + '_ARTTtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection_TT+'&& Tau1_genmatch!=6', wt=weight)
            hists['H_mass'][sample + '_ARQCD_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection_QCD, wt=weight)
            hists['H_mass'][sample + '_ARQCDtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection_QCD+'&& Tau1_genmatch!=6', wt=weight)
            hists['H_mass'][sample + '_ARQCDScaleUp_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightUp')
            hists['H_mass'][sample + '_ARQCDScaleDown_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightDown') 
            hists['H_mass'][sample + '_ARQCDScaleUptrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightUp')
            hists['H_mass'][sample + '_ARQCDScaleDowntrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightDown')

            hists['Jet1_pt'][sample + '_AR_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection, wt=weight)
            hists['Jet1_pt'][sample + '_ARtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
            hists['Jet1_pt'][sample + '_ARTT_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection_TT, wt=weight)
            hists['Jet1_pt'][sample + '_ARTTtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection_TT+'&& Tau1_genmatch!=6', wt=weight)
            hists['Jet1_pt'][sample + '_ARQCD_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection_QCD, wt=weight)
            hists['Jet1_pt'][sample + '_ARQCDtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection_QCD+'&& Tau1_genmatch!=6', wt=weight)
            hists['Jet1_pt'][sample + '_ARQCDScaleUp_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection, wt=weight+' * LHEScaleWeightUp')
            hists['Jet1_pt'][sample + '_ARQCDScaleDown_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection, wt=weight+' * LHEScaleWeightDown') 
            hists['Jet1_pt'][sample + '_ARQCDScaleUptrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightUp')
            hists['Jet1_pt'][sample + '_ARQCDScaleDowntrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightDown')

            hists['collinear_mass'][sample + '_AR_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection, wt=weight)
            hists['collinear_mass'][sample + '_ARtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
            hists['collinear_mass'][sample + '_ARTT_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection_TT, wt=weight)
            hists['collinear_mass'][sample + '_ARTTtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection_TT+'&& Tau1_genmatch!=6', wt=weight)
            hists['collinear_mass'][sample + '_ARQCD_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection_QCD, wt=weight)
            hists['collinear_mass'][sample + '_ARQCDtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection_QCD+'&& Tau1_genmatch!=6', wt=weight)
            hists['collinear_mass'][sample + '_ARQCDScaleUp_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightUp')
            hists['collinear_mass'][sample + '_ARQCDScaleDown_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightDown') 
            hists['collinear_mass'][sample + '_ARQCDScaleUptrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightUp')
            hists['collinear_mass'][sample + '_ARQCDScaleDowntrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightDown')
        
            hists['TauJ_mass'][sample + '_AR_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection, wt=weight)
            hists['TauJ_mass'][sample + '_ARtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
            hists['TauJ_mass'][sample + '_ARTT_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection_TT, wt=weight)
            hists['TauJ_mass'][sample + '_ARTTtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection_TT+'&& Tau1_genmatch!=6', wt=weight)
            hists['TauJ_mass'][sample + '_ARQCD_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection_QCD, wt=weight)
            hists['TauJ_mass'][sample + '_ARQCDtrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection_QCD+'&& Tau1_genmatch!=6', wt=weight)
            hists['TauJ_mass'][sample + '_ARQCDScaleUp_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightUp')
            hists['TauJ_mass'][sample + '_ARQCDScaleDown_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection, wt=weight+' * LHEScaleWeightDown') 
            hists['TauJ_mass'][sample + '_ARQCDScaleUptrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightUp')
            hists['TauJ_mass'][sample + '_ARQCDScaleDowntrue_%s'%selection_prongjet['name']]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight+' * LHEScaleWeightDown')
        ...
        for selection_DR in selections_DR:
            ...
            for selection_prongjet in selections_prong:
                ...
                hists['H_mass'][sample + '_%s_%s'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection, wt=weight)
                hists['Jet1_pt'][sample + '_%s_%s'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection, wt=weight)
                hists['collinear_mass'][sample + '_%s_%s'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection, wt=weight)
                hists['TauJ_mass'][sample + '_%s_%s'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection, wt=weight)
                if 'DR_TT' in selection_DR['name'] or 'CR_TT' in selection_DR['name'] or 'LCR_TT' in selection_DR['name']:
                    ...
                    hists['H_mass'][sample + '_%s_%s_true'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['H_mass'], binning=h_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
                    hists['Jet1_pt'][sample + '_%s_%s_true'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['Jet1_pt'], binning=jet_pt_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
                    hists['collinear_mass'][sample + '_%s_%s_true'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['collinear_mass'], binning=collinear_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
                    hists['TauJ_mass'][sample + '_%s_%s_true'%(selection_DR['name'],selection_prongjet['name'])]= Hist('TH1F', sample=sample, var=['TauJ_mass'], binning=tauj_mass_binning, sel=selection+'&& Tau1_genmatch!=6', wt=weight)
...
fout = ROOT.TFile('root/ff_%s_UL%s_othervar.root'%(channel,year), 'RECREATE')
