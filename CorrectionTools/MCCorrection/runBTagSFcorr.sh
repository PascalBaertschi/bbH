...
python3 btagSFcorr_derive.py -i mutau_UL2018.root
python3 mc_corr.py -y 2018 -c etau
python3 btagSFcorr_derive.py -i etau_UL2018.root
python3 mc_corr.py -y 2018 -c tt
python3 btagSFcorr_derive.py -i tt_UL2018.root
python3 mc_corr.py -y 2018 -c mumu
python3 btagSFcorr_derive.py -i mumu_UL2018.root
python3 mc_corr.py -y 2017 -c mutau
python3 btagSFcorr_derive.py -i mutau_UL2017.root
python3 mc_corr.py -y 2017 -c etau
python3 btagSFcorr_derive.py -i etau_UL2017.root
python3 mc_corr.py -y 2017 -c tt
python3 btagSFcorr_derive.py -i tt_UL2017.root
python3 mc_corr.py -y 2017 -c mumu
python3 btagSFcorr_derive.py -i mumu_UL2017.root
