...
def MakeStackedPlot(name, outdir, hists,selection, cfg):
    if selection=="mumu":
      bkgscheme =  [processComp("W+jets",["WJets_incl","WJets_0J","WJets_1J","WJets_2J"],TColor.GetColor("#e42536")),processComp("t#bar{t}",["TT"],TColor.GetColor("#964a8b")),processComp("Z+jets",["DYJets_incl","DYJets_0J","DYJets_1J","DYJets_2J"],TColor.GetColor("#f89c20")),processComp("ST",["ST_t_channel_antitop","ST_t_channel_top","ST_s_channel","ST_tW_antitop","ST_tW_top"],TColor.GetColor("#832db6")),processComp("VV",["WWTo2L2Nu","WWTo1L1Nu2Q","WWTo4Q","WZTo3LNu","WZTo2L2Q","WZTo1L3Nu","WZTo1L1Nu2Q","ZZTo4L","ZZTo2L2Q","ZZTo2Nu2Q"],TColor.GetColor("#b9ac70"))]
      ...
      #bkgscheme =  [processComp("WJets",["WJets_incl","WJets_0J","WJets_1J","WJets_2J"],TColor.GetColor(222,90,106)),processComp("TT xsecup",["TT_up"],TColor.GetColor(155, 152, 204)),processComp("DYJets",["DYJets_incl","DYJets_0J","DYJets_1J","DYJets_2J"],TColor.GetColor(248, 206, 104)),processComp("ST",["ST_t_channel_antitop","ST_t_channel_top","ST_s_channel","ST_tW_antitop","ST_tW_top"],TColor.GetColor(208,240,193)),processComp("VV",["WWTo2L2Nu","WWTo1L1Nu2Q","WWTo4Q","WZTo3LNu","WZTo2L2Q","WZTo1L3Nu","WZTo1L1Nu2Q","ZZTo4L","ZZTo2L2Q","ZZTo2Nu2Q"],TColor.GetColor(111,45,53))]
      ...
      bkgscheme = [processComp("t#bar{t}",["TT"],TColor.GetColor("#964a8b")),processComp("W+jets",["WJets_incl","WJets_0J","WJets_1J","WJets_2J"],TColor.GetColor("#e42536")),processComp("Z+jets",["DYJets_incl","DYJets_0J","DYJets_1J","DYJets_2J"],TColor.GetColor("#f89c20")),processComp("ST",["ST_t_channel_antitop","ST_t_channel_top","ST_s_channel","ST_tW_antitop","ST_tW_top"],TColor.GetColor("#832db6")),processComp("VV",["WWTo2L2Nu","WWTo1L1Nu2Q","WWTo4Q","WZTo3LNu","WZTo2L2Q","WZTo1L3Nu","WZTo1L1Nu2Q","ZZTo4L","ZZTo2L2Q","ZZTo2Nu2Q"],TColor.GetColor("#b9ac70"))]
    ...
    for entry in bkgscheme:
        ...
        #if hist.Integral()!=0:
        #  hist.Scale(h_data.Integral()/hist.Integral()) #normalize to data
    ...
    if "1btag" in name:
      ...
      #latex.DrawLatex(0.20, 0.75, channel_text+", 1b jet, tt xsec up")
    elif "2btag" in name:
      latex.DrawLatex(0.20, 0.77, channel_text+", 2 b-jets")
      #latex.DrawLatex(0.20, 0.75, channel_text+", 2b jets, tt xsec up")
    else:
    ...
    canv.Print(split_outdir[0]+"/"+split_outdir[1]+'/thesis/Norm_'+ name + '_%s.pdf' %split_outdir[2])
...
#output = './plots/%s_%s/xsecup/'%(channel,year)
...
for path, subnode in node.ListNodes(withObjects=True):
    print(path)
    #if path not in ["LHE_Vpt","vis_pt","vis_mass"]: continue
    if channel=="mumu":
      if path not in ["vis_pt_1btag","vis_pt_2btag","vis_mass_1btag","vis_mass_2btag"]: continue
    if channel in ["mutau","etau"]:
      if path!="Tau1_pt": continue
    if channel=="tt":
      if path!="vis_pt": continue
    #if path!="LHE_Vpt": continue
