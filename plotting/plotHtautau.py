...
for dirname, var, binning in drawvars:
    for sample in getsamples(channel,year,preVFP):
        ...
        if var=="mt":
            if channel=="mutau":
                if sample=='data_obs': #no veto on gen matched taus and no selection on EventNumber
                    selection = 'isHtoMuTau && Mu1_charge*Tau1_charge==-1 && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && nBjets_m>=1'
                    selection_ar = 'isHtoMuTauAR && dimuon_veto==0 && electron_veto==0 && Mu1_charge*Tau1_charge==-1 && extra_muon_veto==0 && nBjets_m>=1'
                else:
                    selection = 'isHtoMuTau && Mu1_charge*Tau1_charge==-1 && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && Tau1_genmatch!=6 && nBjets_m>=1 && EventNumber%10>=4'
                    selection_ar = 'isHtoMuTauAR && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && Mu1_charge*Tau1_charge==-1 && Tau1_genmatch!=6 && nBjets_m>=1 && EventNumber%10>=4'
            elif channel=="etau":
                if sample=='data_obs': #no veto on gen matched taus and no selection on EventNumber
                    selection = 'isHtoETau && Ele1_charge*Tau1_charge==-1 && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && nBjets_m>=1'
                    selection_ar = 'isHtoETauAR && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Ele1_charge*Tau1_charge==-1 && nBjets_m>=1'
                else:
                    selection = 'isHtoETau && Ele1_charge*Tau1_charge==-1 && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Tau1_genmatch!=6 && nBjets_m>=1 && EventNumber%10>=4'
                    selection_ar = 'isHtoETauAR && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Ele1_charge*Tau1_charge==-1 && Tau1_genmatch!=6 && nBjets_m>=1 && EventNumber%10>=4'
        if "sig" in dirname:
