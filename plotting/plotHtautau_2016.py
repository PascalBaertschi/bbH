    ...
    for sample in getsamples(channel,year,preVFP):
        ...
        if channel=="mutau":
            if sample=='data_obs': #no veto on gen matched taus and no selection on EventNumber
                selection = 'isHtoMuTau && Mu1_charge*Tau1_charge==-1 && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && nBjets_m>=1 && mt<60 && Mu1_pt>25.'
                selection_ar = 'isHtoMuTauAR && dimuon_veto==0 && electron_veto==0 && Mu1_charge*Tau1_charge==-1 && extra_muon_veto==0 && nBjets_m>=1 && mt<60 && Mu1_pt>25.'
            else:
                selection = 'isHtoMuTau && Mu1_charge*Tau1_charge==-1 && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && Tau1_genmatch!=6 && nBjets_m>=1 && mt<60 && EventNumber%10>=4 && Mu1_pt>25.'
                selection_ar = 'isHtoMuTauAR && dimuon_veto==0 && electron_veto==0 && extra_muon_veto==0 && Mu1_charge*Tau1_charge==-1 && Tau1_genmatch!=6 && nBjets_m>=1 && mt<60 && EventNumber%10>=4 && Mu1_pt>25.'
        elif channel=="etau":
            if sample=='data_obs': #no veto on gen matched taus and no selection on EventNumber
                selection = 'isHtoETau && Ele1_charge*Tau1_charge==-1 && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && nBjets_m>=1 && mt<60 && Ele1_pt>33.'
                selection_ar = 'isHtoETauAR && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Ele1_charge*Tau1_charge==-1 && nBjets_m>=1 && mt<60 && Ele1_pt>33.'
            else:
                selection = 'isHtoETau && Ele1_charge*Tau1_charge==-1 && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Tau1_genmatch!=6 && nBjets_m>=1 && mt<60 && EventNumber%10>=4 && Ele1_pt>33.'
                selection_ar = 'isHtoETauAR && dielectron_veto==0 && muon_veto==0 && extra_electron_veto==0 && Ele1_charge*Tau1_charge==-1 && Tau1_genmatch!=6 && nBjets_m>=1 && mt<60 && EventNumber%10>=4 && Ele1_pt>33.'
    ...
    if channel=="mutau":
        if year=="2016" and sysvar_noyear=="_nominal":
            if preVFP=="_preVFP":
                ...
                copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_mt_bbH_nominal.Run2016_preVFP_2017ptcut.root'
            elif preVFP!="_comb":
                filename_limit = './root/htt_mt_bbH_nominal.Run2016_postVFP.root'
                copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_mt_bbH_nominal.Run2016_postVFP_2017ptcut.root'
        else:
            filename_limit = './root/htt_mt_bbH%s.Run%s.root'%(sysvar_noyear,year)
            copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_mt_bbH%s.Run%s_2017ptcut.root'%(sysvar_noyear,year)
    elif channel=="etau":
        if year=="2016" and sysvar_noyear=="_nominal":
            if preVFP=="_preVFP":
                filename_limit = './root/htt_et_bbH_nominal.Run2016_preVFP.root'
                copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_et_bbH_nominal.Run2016_preVFP_2017ptcut.root'
            elif preVFP!="_comb":
                filename_limit = './root/htt_et_bbH_nominal.Run2016_postVFP.root'
                copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_et_bbH_nominal.Run2016_postVFP_2017ptcut.root'
        else:
            filename_limit = './root/htt_et_bbH%s.Run%s.root'%(sysvar_noyear,year)
            copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_et_bbH%s.Run%s_2017ptcut.root'%(sysvar_noyear,year)
