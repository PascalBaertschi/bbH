...
def MakeStackedPlot(name, outdir, hists, cfg):
    ...
    signal = [processCompSignal("bbH#tau#tau",["bbHtt"],4,1,50),processCompSignal("ggF (no b-jets)",["jjHtt"],4,2,50)]
    ...
    for fmt in cfg["formats"]:
        canv.Print(outdir + '/' + name + '_Wjets_%s_%s.%s' %(channel,year,fmt))
...
config_by_setting = {
  "x_title": [
    ...
    "hide_data": [('H_mass', True),('vis_mass', False),('BDToutput', False),('BDTisSignal', False),('BDTisTT', False),('BDTisDY', False),('BDTisfake', False),('BDToutSig',True),('BDToutTT',False),('BDToutDY',False),('BDTisBkg', False), ('BDToutBkg', False),('MET', False),('mt',True)],
