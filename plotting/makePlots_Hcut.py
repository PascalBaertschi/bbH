...
def MakeStackedPlot(name, outdir, hists, cfg):
    ...
    if name=="transverse_mass_lepmet":
...
config_by_setting = {
  "x_title": [
    ...
    "hide_data": [('H_mass', True),('collinear_mass', False),('BDToutput', False),('BDTisSignal', False),('BDTisTT', False),('BDTisDY', False),('BDTisfake', False),('BDToutSig',True),('BDToutTT',True),('BDToutDY',True),('BDTisBkg', False), ('BDToutBkg', False),('MET', False)],
    ...
    #"logy":[('BDToutput', True),('BDTisSignal', True),('BDTisTT', True),('BDTisDY', True),('BDTisfake', True),('BDToutSig', True),('BDToutTT', True),('BDToutDY', True),('BDTCR', True),('BDTisBkg', True),('BDToutBkg', True)],
    "logy":[('BDToutput', True),('BDTisSignal', True),('BDTisTT', True),('BDTisDY', True),('BDTisfake', True),('BDToutSig', True),('BDToutTT', True),('BDToutDY', True),('BDTCR', True),('BDTisBkg', True),('BDToutBkg', True)],
