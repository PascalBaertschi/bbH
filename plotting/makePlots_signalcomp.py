...
def MakeStackedPlot(name, outdir, hists, cfg):
    ...
    #bkgscheme =  [processComp("DYJets",["DYJets"], TColor.GetColor(248, 206, 104))]
    ...
    #signal = [processCompSignal("bbH+ggH",["bbHtt"],2,2,1)]
    ...
    #plot.FixTopRange(pads[0],1000., 0.) #change number to change Y axis range
    legend.Draw()
...
output = './plots/%s_signalcomp/'%filename[:-5]
...
config_by_setting = {
  "x_title": [
    ...
    "logy":[('BDToutput', True),('BDTisSignal', True),('BDTisTT', True),('BDTisDY', True),('BDToutSig', True),('BDToutTT', True),('BDToutDY', True),('BDTCR', True),('Ele1_pt', False)],
