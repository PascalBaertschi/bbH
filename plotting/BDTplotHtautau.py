...
if isBDT:
    samplesdir = '/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_UL%s%s%s_BDT/%s/'%(year,preVFP,sysvar,channel)   
else:
...
if isBDT:
    drawvars = [    
        ('BDTisSignal', 'BDTisSignal',  [0,0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.775,0.8,0.825,0.85,0.875,0.9,0.925,0.95,1]),
        ('BDTisTT', 'BDTisTT',          [0,0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.775,0.8,0.825,0.85,0.875,0.9,0.925,0.95,1]),
        ('BDTisDY', 'BDTisDY',  [0,0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.775,0.8,0.825,0.85,0.875,0.9,0.925,0.95,1]),
        ('BDToutput', 'BDToutput',      [0,0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.775,0.8,0.825,0.85,0.875,0.9,0.925,0.95,1]),
        ('BDToutTT', 'BDToutTT',      [0,0.25,0.5,0.75,1]),
        ('BDToutDY', 'BDToutDY',      [0,0.25,0.5,0.75,1]),
        ('BDTCR', 'BDTCR',      [0,0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.775,0.8,0.825,0.85,0.875,0.9,0.925,0.95,1]),
        ('H_mass',      'H_mass',       (30, 0., 350.)),
    ...
    if channel=='mutau':
        if year=='2018':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.48, 0.525, 0.575, 0.645, 0.675, 0.7, 0.75, 0.79, 0.82, 0.845, 0.865, 0.89, 0.92, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.485, 0.55, 0.65, 0.69, 0.75, 0.805, 0.84, 0.87, 0.905, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.495, 0.55, 0.645, 0.685, 0.74, 0.79, 0.825, 0.855, 0.88, 0.915, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.855, 0.86, 0.87, 0.89, 0.895, 0.915, 0.92, 0.925, 0.93, 0.935, 0.94, 0.955, 0.965, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.58, 0.685, 0.75, 0.81, 0.835, 0.855, 0.87, 0.88, 0.895, 0.915, 0.925, 0.935, 0.94, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.48, 0.58, 0.63, 0.655, 0.695, 0.725, 0.75, 0.765, 0.795, 0.82, 0.825, 0.845, 0.85, 0.855, 0.865, 0.87, 0.885, 0.895, 0.91, 0.92, 0.925, 0.93, 1.0]),]
        elif year=='2017':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.455, 0.505, 0.56, 0.605, 0.66, 0.705, 0.75, 0.78, 0.805, 0.83, 0.86, 0.89, 0.925, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.435, 0.525, 0.595, 0.665, 0.73, 0.785, 0.825, 0.865, 0.905, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.47, 0.525, 0.58, 0.655, 0.695, 0.75, 0.785, 0.82, 0.85, 0.885, 0.915, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.89, 0.905, 0.91, 0.925, 0.945, 0.95, 0.955, 0.96, 0.965, 0.97, 0.975, 0.98, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.5, 0.655, 0.72, 0.78, 0.815, 0.83, 0.86, 0.89, 0.905, 0.92, 0.945, 0.95, 0.96, 0.97, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.505, 0.64, 0.705, 0.725, 0.765, 0.785, 0.81, 0.84, 0.855, 0.865, 0.885, 0.915, 0.93, 0.945, 0.96, 0.97, 0.975, 1.0]),]
        elif year=='2016':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.48, 0.525, 0.55, 0.625, 0.69, 0.725, 0.76, 0.795, 0.825, 0.855, 0.875, 0.9, 0.935, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.425, 0.525, 0.595, 0.7, 0.745, 0.795, 0.835, 0.87, 0.905, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.445, 0.52, 0.56, 0.66, 0.715, 0.75, 0.795, 0.835, 0.865, 0.89, 0.92, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.865, 0.87, 0.89, 0.895, 0.9, 0.905, 0.92, 0.925, 0.93, 0.935, 0.94, 0.945, 0.955, 0.96, 0.965, 0.97, 0.975, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.53, 0.705, 0.745, 0.795, 0.825, 0.845, 0.87, 0.89, 0.895, 0.905, 0.935, 0.945, 0.955, 0.965, 0.97, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.545, 0.63, 0.735, 0.78, 0.795, 0.815, 0.83, 0.845, 0.855, 0.87, 0.885, 0.89, 0.9, 0.91, 0.93, 0.935, 0.94, 0.955, 0.96, 0.965, 0.975, 1.0]),]
    elif channel=='etau':
        if year=='2018':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.53, 0.585, 0.645, 0.7, 0.72, 0.755, 0.78, 0.8, 0.83, 0.86, 0.895, 0.91, 0.945, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.5, 0.56, 0.65, 0.715, 0.765, 0.8, 0.845, 0.895, 0.92, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.48, 0.535, 0.615, 0.685, 0.74, 0.77, 0.8, 0.84, 0.875, 0.905, 0.94, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.895, 0.9, 0.905, 0.91, 0.94, 0.95, 0.955, 0.97, 0.975, 0.98, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.64, 0.74, 0.755, 0.78, 0.785, 0.82, 0.84, 0.87, 0.895, 0.9, 0.905, 0.91, 0.94, 0.955, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.495, 0.695, 0.765, 0.8, 0.825, 0.845, 0.86, 0.875, 0.885, 0.9, 0.905, 0.91, 0.92, 0.925, 0.945, 0.95, 0.955, 1.0]),]
        elif year=='2017':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.5, 0.585, 0.65, 0.695, 0.72, 0.785, 0.82, 0.84, 0.86, 0.88, 0.91, 0.95, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.465, 0.585, 0.66, 0.705, 0.77, 0.82, 0.855, 0.885, 0.945, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.41, 0.555, 0.635, 0.67, 0.71, 0.75, 0.805, 0.84, 0.87, 0.9, 0.95, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.82, 0.855, 0.87, 0.88, 0.935, 0.94, 0.945, 0.95, 0.955, 0.965, 0.97, 0.975, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.635, 0.695, 0.77, 0.82, 0.835, 0.855, 0.87, 0.885, 0.9, 0.935, 0.94, 0.945, 0.95, 0.955, 0.97, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.67, 0.79, 0.865, 0.905, 0.935, 0.95, 0.96, 0.97, 1.0]),]
        elif year=='2016':
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.47, 0.55, 0.595, 0.64, 0.685, 0.7, 0.74, 0.765, 0.805, 0.835, 0.855, 0.885, 0.91, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.47, 0.56, 0.625, 0.69, 0.735, 0.77, 0.83, 0.865, 0.895, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.535, 0.58, 0.635, 0.69, 0.73, 0.76, 0.805, 0.84, 0.88, 0.9, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.885, 0.89, 0.91, 0.915, 0.93, 1.0]),]
            #drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.58, 0.69, 0.735, 0.745, 0.775, 0.835, 0.855, 0.885, 0.89, 0.91, 0.93, 1.0]),]
            drawvars = drawvars+[('BDToutSig', 'BDToutSig', [0.0, 0.57, 0.685, 0.825, 0.855, 0.89, 0.91, 1.0]),]
            ...
            if isBDT:
                ...
                if sample!="data_obs":  #following uncertainties only for MC
                    ...
                    if year in ["2017","2016"]:
                        hists[dirname][sample + '_prefiringUp'] = Hist('TH1F', sample=sample, var=[var], binning=binning, sel=selection, wt=weight+' * PrefireWeight_up')
                        hists[dirname][sample + '_prefiringDown'] = Hist('TH1F', sample=sample, var=[var], binning=binning, sel=selection, wt=weight+' * PrefireWeight_down')
...
if isBDT and sysvar=="":
    ...
    if channel=="mutau":
        ...
        channel_sys = channel
    variations_list = ["","ff%sUp"%year,"ff%sDown"%year,"Hcut","Hsigcut","cut","sig"+year,"tt"+year,"dy"+year,"eff_trig_%s_%sUp"%(channel_sys,year),"eff_trig_%s_%sDown"%(channel_sys,year),"ttbarShapeUp","ttbarShapeDown","dyShapeUp","dyShapeDown","dyShape1bUp","dyShape1bDown","dyShape2bUp","dyShape2bDown","dyxsecUp","dyxsecDown","dyxsec1bUp","dyxsec1bDown","dyxsec2bUp","dyxsec2bDown","fake_m_%sUp"%year,"fake_m_%sDown"%year,"fake_e_%sUp"%year,"fake_e_%sDown"%year,"QCDscaleUp","QCDscaleDown","QCDscaleMURUp","QCDscaleMURDown","QCDscaleMUFUp","QCDscaleMUFDown","QCDscaleMURSigUp","QCDscaleMURSigDown","QCDscaleMUFSigUp","QCDscaleMUFSigDown","QCDscaleMURTTUp","QCDscaleMURTTDown","QCDscaleMUFTTUp","QCDscaleMUFTTDown","QCDscaleMURDYUp","QCDscaleMURDYDown","QCDscaleMUFDYUp","QCDscaleMUFDYDown","PS_ISRUp","PS_ISRDown","PS_FSRUp","PS_FSRDown"]+ff_variations+btag_variations+tauid_variations
    #variations_list = ["","ff%sUp"%year,"ff%sDown"%year,"Hcut","Hsigcut","cut","sig"+year]
elif sysvar!="":
    variations_list = [""]
else:
...
for path, node in hists.ListNodes(withObjects=True):
    ...
    #for QCDscale_var in ["_QCDscaleMURUp","_QCDscaleMURDown","_QCDscaleMUFUp","_QCDscaleMUFDown"]:
    #    node['ggH_bb_htt%s'%QCDscale_var] = node['ggH_bb_htt_inc%s'%QCDscale_var] + node['ggH_bb_htt_excl%s'%QCDscale_var]
    #    node['ggH_htt%s'%QCDscale_var] = node['ggH_htt_inc%s'%QCDscale_var] + node['ggH_htt_excl%s'%QCDscale_var]
    #    node['bbHtt%s'%QCDscale_var] = node['bbH_htt%s'%QCDscale_var] + node['ggH_bb_htt_inc%s'%QCDscale_var] + node['ggH_bb_htt_excl%s'%QCDscale_var] - node['intH_bb_htt%s'%QCDscale_var]
    #    node['jjHtt%s'%QCDscale_var] = node['bbH_nobb_htt%s'%QCDscale_var] + node['ggH_htt_inc%s'%QCDscale_var] + node['ggH_htt_excl%s'%QCDscale_var] - node['intH_htt%s'%QCDscale_var]
    ...
    for variation in variations_list_AR:
        ...
        node['MC_AR%s'%variation] = node['DYJets_AR%s'%variation] + node['WJets_AR%s'%variation] + node['TT_AR%s'%variation] + node['ST_AR%s'%variation] + node['VBF_AR%s'%variation] + node['ZH_AR%s'%variation] + node['VV_AR%s'%variation] + node['ttH_AR%s'%variation] + node['jjHtt_AR%s'%variation]
        ...
        if "ff" in variation: #for fakefactor up and down only QCD changes
            node['MC%s'%variation] = node['DYJets'] + node['WJets'] + node['TT'] + node['ST'] + node['QCD%s'%variation] + node['VV'] + node['VBF'] + node['ZH'] + node['ttH'] + node['jjHtt']
        else:
            node['MC%s'%variation] = node['DYJets%s'%variation] + node['WJets%s'%variation] + node['TT%s'%variation] + node['ST%s'%variation] + node['QCD%s'%variation] + node['VV%s'%variation] + node['VBF%s'%variation] + node['ZH%s'%variation] + node['ttH%s'%variation] + node['jjHtt%s'%variation]
...
if isBDT:
    if channel=="mutau":
        ...
        copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_mt_bbH%s.Run%s.root'%(sysvar_noyear,year)
    elif channel=="etau":
        filename_limit = './root/htt_et_bbH%s.Run%s.root'%(sysvar_noyear,year)
        copyfile_to = '/work/pbaertsc/bbh/CMSSW_10_2_13/src/CombineHarvester/bbHRun2Legacy/shapes/htt_et_bbH%s.Run%s.root'%(sysvar_noyear,year)
