...
def MakeStackedPlot(name, outdir, hists, cfg):
    ...
    bkgscheme = [processComp("H(125)",["ZH","WH","VBF","ttH"],TColor.GetColor(250, 202, 255))]
    ...
    signal = [processCompSignal("bbH+ggH",["bbHtt"],4,1,1),processCompSignal("ggF (no b-jets)",["jjHtt"],4,2,1)]
...
config_by_setting = {
  "x_title": [
    ...
    #"logy":[('BDToutput', False),('BDTisSignal', False),('BDTisTT', False),('BDTisDY', False),('BDTisfake', False),('BDToutSig', True),('BDToutTT', True),('BDToutDY', True),('BDTCR', False),('BDTisBkg', False),('BDToutBkg', False),('H_mass', False)],
    #"logy_min":[('BDToutput', 1),('BDTisSignal', 1),('BDTisTT', 1),('BDTisDY', 1),('BDTisfake', 1),('BDToutSig', 0.0001),('BDToutTT', 1),('BDToutDY', 1),('BDTCR', 1),('BDTisBkg', 1), ('BDToutBkg', 1)],
    }
    # "ratio_range" :[
    #     ('vis_mass', [0,5])]}
