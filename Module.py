...
from CorrectionTools.PUIdSF import *
...
class Producer(Module):
    ...
    def __init__(self, name, DataType, filelist, **kwargs):
        ...
        if self.JECvar!="" or self.tes!="":
            self.sample = filelist[0].split("/")[-2]+"__UL%s"%year
        else:
        ...
        if self.year==2018 or self.year==2017:
            self.trigger_E32 = TrigObjMatcher(trigdata.combdict['SingleElectron_32'])
            self.trigger_E35 = TrigObjMatcher(trigdata.combdict['SingleElectron_35'])
        ...
        if self.isMC:
            ...
            self.puidSF = PUIdSF(self.year,self.preVFP)
            if self.year==2018:
                LUMI = 59740
            elif self.year==2017:
                LUMI = 41530
            ...
            LHEScaleSumw_path = '/work/pbaertsc/bbh/NanoTreeProducer/json/LHEScaleSumw/UL%s%s/'%(self.year,self.preVFP)
            self.LHEScaleSumw = utils.getLHEScaleSumw(LHEScaleSumw_path,self.sample_name,self.year,self.preVFP)
            ...
            print("nevents from JSON:",nevents)
            print("nevents from calc:",utils.getgenEventSumw(LHEScaleSumw_path,self.sample_name,self.year,self.preVFP))
    ...
    def fillBranches(self,event):
        ...
        self.out.PUIdWeight[0]             = self.PUIdWeight
        self.out.PUIdWeight_up[0]          = self.PUIdWeight_up
        self.out.PUIdWeight_down[0]        = self.PUIdWeight_down
        ...
        self.out.MuTriggerWeight_fit[0]     = self.MuTriggerWeight_fit
        ...
        self.out.TauWeightVSjet_1prong_up[0]   = self.TauWeightVSjet_1prong_up
        self.out.TauWeightVSjet_1prong_down[0] = self.TauWeightVSjet_1prong_down
        self.out.TauWeightVSjet_1prong1pi_up[0]   = self.TauWeightVSjet_1prong1pi_up
        self.out.TauWeightVSjet_1prong1pi_down[0] = self.TauWeightVSjet_1prong1pi_down
        self.out.TauWeightVSjet_3prong_up[0]   = self.TauWeightVSjet_3prong_up
        self.out.TauWeightVSjet_3prong_down[0] = self.TauWeightVSjet_3prong_down
        ...
        self.out.extra_muon_veto            = self.extra_muon_veto
        self.out.extra_electron_veto        = self.extra_electron_veto
        self.out.nPV[0]                     = event.PV_npvsGood
        self.out.nTaus_vetomu[0]            = self.nTaus_vetomu
        self.out.nTaus_vetoe[0]             = self.nTaus_vetoe
        ...
        self.out.LHEScaleWeightUp[0]        = self.LHEScaleWeightUp
        self.out.LHEScaleWeightDown[0]      = self.LHEScaleWeightDown
        self.out.LHEScaleWeightMURUp[0]     = self.LHEScaleWeightMURUp
        self.out.LHEScaleWeightMURDown[0]   = self.LHEScaleWeightMURDown
        self.out.LHEScaleWeightMUFUp[0]     = self.LHEScaleWeightMUFUp
        self.out.LHEScaleWeightMUFDown[0]   = self.LHEScaleWeightMUFDown
        self.out.PSWeightISRUp[0]           = self.PSWeightISRUp
        self.out.PSWeightISRDown[0]         = self.PSWeightISRDown
        self.out.PSWeightFSRUp[0]           = self.PSWeightFSRUp
        self.out.PSWeightFSRDown[0]         = self.PSWeightFSRDown
        ...
        self.out.Jet1_nMuons[0]             = self.Jet1_nMuons
        self.out.Jet1_nElectrons[0]         = self.Jet1_nElectrons
        self.out.Jet1_nConstituents[0]      = self.Jet1_nConstituents
        ...
        self.out.Jet2_nMuons[0]             = self.Jet2_nMuons
        self.out.Jet2_nElectrons[0]         = self.Jet2_nElectrons
        self.out.Jet2_nConstituents[0]      = self.Jet2_nConstituents
        ...
        self.out.Jet3_nMuons[0]             = self.Jet3_nMuons
        self.out.Jet3_nElectrons[0]         = self.Jet3_nElectrons
        self.out.Jet3_nConstituents[0]      = self.Jet3_nConstituents
        ...
        self.out.Ele1_sl32trig_fired[0]     = self.Ele1_sl32trig_fired
        self.out.Ele1_sl35trig_fired[0]     = self.Ele1_sl35trig_fired
        ...
        self.out.MET_puppi[0]               = self.MET_puppi
        self.out.MET_puppi_phi[0]           = self.MET_puppi_phi
        self.out.MET_chs[0]                 = self.MET_chs
        self.out.MET_chs_phi[0]             = self.MET_chs_phi
        self.out.MET_px[0]                  = self.MET_px
        self.out.MET_py[0]                  = self.MET_py
        self.out.MET_covXX[0]               = self.MET_covXX
        self.out.MET_covXY[0]               = self.MET_covXY
        self.out.MET_covYY[0]               = self.MET_covYY
        ...
        self.out.mt[0]                      = self.mt
        self.out.mt_up[0]                   = self.mt_up
        self.out.mt_down[0]                 = self.mt_down
        ...
        self.out.wt_ff_nocorr_flat[0]       = self.wt_ff_nocorr_flat
        ...
        self.out.wt_ff_qcd_flat[0]          = self.wt_ff_qcd_flat
        ...
        self.out.wt_ffcorr_collinearmass_tt[0]= self.wt_ffcorr_collinearmass_tt
        self.out.wt_ffcorr_taujmass_tt[0]   = self.wt_ffcorr_taujmass_tt
        ...
        self.out.wt_ff_qcdfitpar0Up[0]      = self.wt_ff_qcdfitpar0Up   
        self.out.wt_ff_qcdfitpar0Down[0]    = self.wt_ff_qcdfitpar0Down 
        self.out.wt_ff_qcdfitpar1Up[0]      = self.wt_ff_qcdfitpar1Up   
        self.out.wt_ff_qcdfitpar1Down[0]    = self.wt_ff_qcdfitpar1Down 
        self.out.wt_ff_wfitpar0Up[0]        = self.wt_ff_wfitpar0Up   
        self.out.wt_ff_wfitpar0Down[0]      = self.wt_ff_wfitpar0Down
        ...
        self.out.wt_ff_ttfitpar0Up[0]       = self.wt_ff_ttfitpar0Up 
        self.out.wt_ff_ttfitpar0Down[0]     = self.wt_ff_ttfitpar0Down 
        self.out.wt_ff_ttfitpar1Up[0]       = self.wt_ff_ttfitpar1Up
        self.out.wt_ff_ttfitpar1Down[0]     = self.wt_ff_ttfitpar1Down
        self.out.wt_ff_fracUp[0]            = self.wt_ff_fracUp
        self.out.wt_ff_fracDown[0]          = self.wt_ff_fracDown
        self.out.wt_dy[0]                   = self.wt_dy
        self.out.wt_dy_up[0]                = self.wt_dy_up
        self.out.wt_dy_down[0]              = self.wt_dy_down
        self.out.wt_dy_1b_up[0]             = self.wt_dy_1b_up
        self.out.wt_dy_1b_down[0]           = self.wt_dy_1b_down
        self.out.wt_dy_2b_up[0]             = self.wt_dy_2b_up
        self.out.wt_dy_2b_down[0]           = self.wt_dy_2b_down
        self.out.wt_dy_ttxsecup[0]          = self.wt_dy_ttxsecup
        self.out.wt_dy_ttxsecdown[0]        = self.wt_dy_ttxsecdown
        self.out.wt_dy_1b_ttxsecup[0]       = self.wt_dy_1b_ttxsecup
        self.out.wt_dy_1b_ttxsecdown[0]     = self.wt_dy_1b_ttxsecdown
        self.out.wt_dy_2b_ttxsecup[0]       = self.wt_dy_2b_ttxsecup
        self.out.wt_dy_2b_ttxsecdown[0]     = self.wt_dy_2b_ttxsecdown
        ...
        self.out.wt_tt_pt[0]                = self.wt_tt_pt
        self.out.wt_tt_pt_up[0]             = self.wt_tt_pt_up
        self.out.wt_tt_pt_down[0]           = self.wt_tt_pt_down
        ...
        self.out.ff_fitunc_qcd_par0_up[0]   = self.ff_fitunc_qcd_par0_up
        self.out.ff_fitunc_qcd_par0_down[0] = self.ff_fitunc_qcd_par0_down
        self.out.ff_fitunc_qcd_par1_up[0]   = self.ff_fitunc_qcd_par1_up
        self.out.ff_fitunc_qcd_par1_down[0] = self.ff_fitunc_qcd_par1_down
        self.out.ff_fitunc_w_par0_up[0]     = self.ff_fitunc_w_par0_up
        self.out.ff_fitunc_w_par0_down[0]   = self.ff_fitunc_w_par0_down
        self.out.ff_fitunc_w_par1_up[0]     = self.ff_fitunc_w_par1_up
        self.out.ff_fitunc_w_par1_down[0]   = self.ff_fitunc_w_par1_down
        self.out.ff_fitunc_w_par2_up[0]     = self.ff_fitunc_w_par2_up
        self.out.ff_fitunc_w_par2_down[0]   = self.ff_fitunc_w_par2_down
        self.out.ff_fitunc_tt_par0_up[0]    = self.ff_fitunc_tt_par0_up
        self.out.ff_fitunc_tt_par0_down[0]  = self.ff_fitunc_tt_par0_down
        self.out.ff_fitunc_tt_par1_up[0]    = self.ff_fitunc_tt_par1_up
        self.out.ff_fitunc_tt_par1_down[0]  = self.ff_fitunc_tt_par1_down
        ...
        self.out.E32Trigger_fired[0]        = self.E32Trigger_fired
        self.out.E35Trigger_fired[0]        = self.E35Trigger_fired
    ...
    def analyze(self, event):
        ...
        self.LHE_Vpt               =-1.
        self.LHEPdfWeight          = 1.
        self.LHEScaleWeightUp      = 1.
        self.LHEScaleWeightDown    = 1.
        self.LHEScaleWeightMURUp   = 1.
        self.LHEScaleWeightMURDown = 1.
        self.LHEScaleWeightMUFUp   = 1.
        self.LHEScaleWeightMUFDown = 1.
        self.PSWeightISRUp         = 1.
        self.PSWeightISRDown       = 1.
        self.PSWeightFSRUp         = 1.
        self.PSWeightFSRDown       = 1.
        self.EventWeight           = 1.
        self.BTagWeight            = 1.
        ...
        self.PUIdWeight               = 1.
        self.PUIdWeight_up            = 1.
        self.PUIdWeight_down          = 1.
        self.GenWeight             = 1.
        self.PUWeight              = 1.
        self.PUWeight_up           = 1.
        ...
        self.TauWeightVSjet_1prong_up     = 1.
        self.TauWeightVSjet_1prong_down   = 1.
        self.TauWeightVSjet_1prong1pi_up     = 1.
        self.TauWeightVSjet_1prong1pi_down   = 1.
        self.TauWeightVSjet_3prong_up     = 1.
        self.TauWeightVSjet_3prong_down   = 1.
        ...
        self.extra_muon_veto       = False
        self.extra_electron_veto   = False
        self.Mu1_pt                = -1.
        self.Mu1_eta               = -10.
        self.Mu1_phi               = -10.
        self.Mu1_mass              = -1.
        ...
        self.Ele1_sl32trig_fired   = False
        self.Ele1_sl35trig_fired   = False
        ...
        self.Jet1_nMuons           = -1.
        self.Jet1_nElectrons       = -1.
        self.Jet1_nConstituents    = -1.
        self.Jet2_pt               = -1.
        self.Jet2_eta              = -10.
        self.Jet2_phi              = -10.
        self.Jet2_mass             = -1.
        ...
        self.Jet2_nMuons           = -1.
        self.Jet2_nElectrons       = -1.
        self.Jet2_nConstituents    = -1.
        self.Jet3_pt               = -1.
        self.Jet3_eta              = -10.
        self.Jet3_phi              = -10.
        self.Jet3_mass             = -1.
        ...
        self.Jet3_nMuons           = -1.
        self.Jet3_nElectrons       = -1.
        self.Jet3_nConstituents    = -1.
        self.Bjet1_pt              = -1.
        self.Bjet1_eta             = -10.
        self.Bjet1_phi             = -10.
        self.Bjet1_mass            = -1.
        ...
        self.wt_ffcorr_collinearmass_tt= 1.
        self.wt_ffcorr_taujmass_tt = 1.
        self.wt_ffUp               = 0.
        self.wt_ffDown             = 0.
        self.wt_ff_qcdUp           = 0.
        ...
        self.wt_ff_ttUp            = 0.
        self.wt_ff_ttDown          = 0.
        self.wt_ff_qcdfitpar0Up    = 0.
        self.wt_ff_qcdfitpar0Down  = 0.
        self.wt_ff_qcdfitpar1Up    = 0.
        self.wt_ff_qcdfitpar1Down  = 0.
        self.wt_ff_wfitpar0Up      = 0.
        self.wt_ff_wfitpar0Down    = 0.
        self.wt_ff_wfitpar1Up      = 0.
        self.wt_ff_wfitpar1Down    = 0.
        self.wt_ff_wfitpar2Up      = 0.
        self.wt_ff_wfitpar2Down    = 0.
        self.wt_ff_ttfitpar0Up     = 0.
        self.wt_ff_ttfitpar0Down   = 0.
        self.wt_ff_ttfitpar1Up     = 0.
        self.wt_ff_ttfitpar1Down   = 0. 
        self.wt_ff_fracUp          = 0.
        self.wt_ff_fracDown        = 0.
        self.ffunc_qcd             = 0.
        self.ffunc_w               = 0.
        self.ffunc_tt              = 0.
        self.ff_fitunc_qcd_par0_up = 0.
        self.ff_fitunc_qcd_par0_down = 0.
        self.ff_fitunc_qcd_par1_up = 0.
        self.ff_fitunc_qcd_par1_down = 0.
        self.ff_fitunc_w_par0_up     = 0.
        self.ff_fitunc_w_par0_down   = 0.
        self.ff_fitunc_w_par1_up     = 0.
        self.ff_fitunc_w_par1_down   = 0.
        self.ff_fitunc_w_par2_up     = 0.
        self.ff_fitunc_w_par2_down   = 0.
        self.ff_fitunc_tt_par0_up    = 0.
        self.ff_fitunc_tt_par0_down  = 0.
        self.ff_fitunc_tt_par1_up    = 0.
        self.ff_fitunc_tt_par1_down  = 0.
        self.wt_dy                 = 1.
        self.wt_dy_up              = 1.
        self.wt_dy_down            = 1.
        self.wt_dy_1b_up           = 1.
        self.wt_dy_1b_down         = 1.
        self.wt_dy_2b_up           = 1.
        self.wt_dy_2b_down         = 1.
        self.wt_dy_ttxsecup        = 1.
        self.wt_dy_ttxsecdown      = 1.
        self.wt_dy_1b_ttxsecup     = 1.
        self.wt_dy_1b_ttxsecdown   = 1.
        self.wt_dy_2b_ttxsecup     = 1.
        self.wt_dy_2b_ttxsecdown   = 1.
        self.wt_dy_old             = 1.
        self.wt_dy_reco            = 1.
        self.wt_tt                 = 1.
        self.wt_tt_pol1            = 1.
        ...
        self.E32Trigger_fired        = False
        self.E35Trigger_fired        = False
        ...
        if self.isMC:
            ...
            if self.year in [2016,2017]:
                ...
                self.PrefireWeight_up = event.PrefireWeight_Up
                self.PrefireWeight_down = event.PrefireWeight_Down
            ...
            #LHE scale variation weights (w_var / w_nominal); [0] is MUF="0.5" MUR="0.5"; [1] is MUF="1.0" MUR="0.5"; [2] is MUF="2.0" MUR="0.5"; [3] is MUF="0.5" MUR="1.0"; [4] is MUF="1.0" MUR="1.0"; [5] is MUF="2.0" MUR="1.0"; [6] is MUF="0.5" MUR="2.0"; [7] is MUF="1.0" MUR="2.0"; [8] is MUF="2.0" MUR="2.0"* for most samples
            #LHE scale variation weights (w_var / w_nominal); [0] is MUF="0.5" MUR="0.5"; [1] is MUF="1.0" MUR="0.5"; [2] is MUF="2.0" MUR="0.5"; [3] is MUF="0.5" MUR="1.0"; [4] is MUF="2.0" MUR="1.0"; [5] is MUF="0.5" MUR="2.0"; [6] is MUF="1.0" MUR="2.0"; [7] is MUF="2.0" MUR="2.0"* for bbH_yb2 and bbH_ybyt samples
            if self.LHEScaleSumw[8]>2. or self.LHEScaleSumw[8]<0.1: # only bbH_yb2 and bbH_ybyt samples
                self.LHEScaleWeightUp = event.LHEScaleWeight[7]/self.LHEScaleSumw[7] 
                self.LHEScaleWeightDown = event.LHEScaleWeight[0]/self.LHEScaleSumw[0]
                self.LHEScaleWeightMURUp = event.LHEScaleWeight[6]/self.LHEScaleSumw[6]
                self.LHEScaleWeightMURDown = event.LHEScaleWeight[1]/self.LHEScaleSumw[1]
                self.LHEScaleWeightMUFUp = event.LHEScaleWeight[4]/self.LHEScaleSumw[4]
                self.LHEScaleWeightMUFDown = event.LHEScaleWeight[3]/self.LHEScaleSumw[3]
            else: #other MC samples
                self.LHEScaleWeightUp = event.LHEScaleWeight[8]/self.LHEScaleSumw[8] 
                self.LHEScaleWeightDown = event.LHEScaleWeight[0]/self.LHEScaleSumw[0]
                self.LHEScaleWeightMURUp = event.LHEScaleWeight[7]/self.LHEScaleSumw[7]
                self.LHEScaleWeightMURDown = event.LHEScaleWeight[1]/self.LHEScaleSumw[1]
                self.LHEScaleWeightMUFUp = event.LHEScaleWeight[5]/self.LHEScaleSumw[5]
                self.LHEScaleWeightMUFDown = event.LHEScaleWeight[3]/self.LHEScaleSumw[3]
            self.PSWeightISRUp = event.PSWeight[0] #[0] is ISR=2 FSR=1; [1] is ISR=1 FSR=2[2] is ISR=0.5 FSR=1; [3] is ISR=1 FSR=0.5;
            self.PSWeightISRDown = event.PSWeight[2] 
            self.PSWeightFSRUp = event.PSWeight[1]
            self.PSWeightFSRDown = event.PSWeight[3]
        ...
        for tau in taus:
            ...
            if self.isMC:
                if "Up" in self.tes:
                    if (self.tes == "scale_t_1prongUp" and tau_decaymode==0) or (self.tes == "scale_t_1prong1piUp" and tau_decaymode == 1) or (self.tes == "scale_t_3prongUp" and tau_decaymode==10):
                    ...
                    if (self.tes == "scale_t_1prongDown" and tau_decaymode==0) or (self.tes == "scale_t_1prong1piDown" and tau_decaymode == 1) or (self.tes == "scale_t_3prongDown" and tau_decaymode==10):
        ...
        #disregard event if no taus for JEC or tes variation
        if (self.JECvar!="" or self.tes!="") and len(tau_vetomu_list)==0 and len(tau_vetoe_list)==0:
            return False
        ...
        self.nTaus_vetomu = len(tau_vetomu_list)
        self.nTaus_vetoe = len(tau_vetoe_list)
        self.nMuons = len(muon_list)
        self.nElectrons = len(electron_list)
        self.nMuons_veto = len(muon_veto_list)
        self.nElectrons_veto = len(electron_veto_list)

        if self.nMuons_veto>1:
            self.extra_muon_veto = True
        if self.nElectrons_veto>1:
            self.extra_electron_veto = True
        ...
        if (self.JECvar!="" or self.tes!="") and not (self.isHtoMuTau or self.isHtoETau): #only save SR for jec and tes variations
            return False
        ...
        if self.year==2018 or self.year==2017:
            self.E32Trigger_fired = self.trigger_E32.fired(event)
            self.E35Trigger_fired = self.trigger_E35.fired(event)
        ...
        if isMuTau:
            ...
            if self.year==2017:
                self.Ele1_sl35trig_fired = self.trigger_E35.match(event,pair[0])
                self.Ele1_sl32trig_fired = self.trigger_E32.match(event,pair[0])
        ...
        if isMuTau or isETau:
            ...
            if self.isHtoMuTau or self.isHtolooseMuTau:
                ...
                self.Tau1_Idvsjetwp    = "Medium" #less than medium that's why medium WP
                self.Tau1_Idvsewp      = "VVLoose"
                self.Tau1_Idvsmuwp     = "Tight"
        ...
        if self.isMC:
            if isMuTau:
                ...
                MuTriggerSF               = self.triggerSFs.getTriggerSF("mutau",self.Mu1_pt,self.Mu1_eta)
                self.MuTriggerWeight      = MuTriggerSF
                MuTriggerSFUnc          = self.triggerSFs.getTriggerSFUnc("mutau",self.Mu1_pt,self.Mu1_eta)
                self.MuTriggerWeight_fit  = MuTriggerSFUnc[0]
                self.MuTriggerWeight_gen  = MuTriggerSFUnc[1]
                self.MuTriggerWeight_up   = MuTriggerSFUnc[2]
                self.MuTriggerWeight_down = MuTriggerSFUnc[3]
                """
                ...
                self.TauWeightVSjet_1prong_up      = TauSF[10]
                self.TauWeightVSjet_1prong_down    = TauSF[11]
                self.TauWeightVSjet_1prong1pi_up   = TauSF[12]
                self.TauWeightVSjet_1prong1pi_down = TauSF[13]
                self.TauWeightVSjet_3prong_up      = TauSF[14]
                self.TauWeightVSjet_3prong_down    = TauSF[15]
            elif isETau:
                ...
                ETriggerSF               = self.triggerSFs.getTriggerSF("etau",self.Ele1_pt,self.Ele1_eta)
                self.ETriggerWeight      = ETriggerSF
                ETriggerSFUnc          = self.triggerSFs.getTriggerSFUnc("etau",self.Ele1_pt,self.Ele1_eta)
                self.ETriggerWeight_fit  = ETriggerSFUnc[0]
                self.ETriggerWeight_gen  = ETriggerSFUnc[1]
                self.ETriggerWeight_up   = ETriggerSFUnc[2]
                self.ETriggerWeight_down = ETriggerSFUnc[3]
                if self.year==2017:
                    self.ETriggerWeight_35 = self.triggerSFs.getTriggerSFTAG("etau",self.Ele1_pt,self.Ele1_eta)
                """
        ...
        ###################################################################################################
        self.MET = event.MET_T1_pt #nominal MET (data and MC)
        self.MET_phi = event.MET_T1_phi #nominal MET phi (data and MC)
        self.MET_puppi      = event.PuppiMET_pt
        self.MET_puppi_phi  = event.PuppiMET_phi
        self.MET_chs     = event.MET_pt
        self.MET_chs_phi = event.MET_phi

        if "jes" in self.JECvar:
            self.MET         = eval("event.MET_T1_pt_%s"%self.JECvar)
            self.MET_phi     = eval("event.MET_T1_phi_%s"%self.JECvar)
        elif self.JECvar=='jerDown':
            try:
                self.MET = event.MET_T1_pt_jerDown
                self.MET_phi = event.MET_T1_phi_jerDown
            except: #if JER is split
                jersplitId = getJERsplitID(event.MET_pt,event.MET_phi) 
                self.MET          = eval("event.MET_T1_pt_jer%sDown"%jersplitId)
                self.MET_phi      = eval("event.MET_T1_phi_jer%sDown"%jersplitId)
        elif self.JECvar=='jerUp':
            try:
                self.MET = event.MET_T1_pt_jerUp
                self.MET_phi = event.MET_T1_phi_jerUp
            except: #if JER is split
                jersplitId = getJERsplitID(event.MET_pt,event.MET_phi)
                self.MET          = eval("event.MET_T1_pt_jer%sUp"%jersplitId)
                self.MET_phi      = eval("event.MET_T1_phi_jer%sUp"%jersplitId)
        elif self.JECvar=="met_unclusteredDown":
            self.MET = event.MET_T1_pt_unclustEnDown
            self.MET_phi = event.MET_T1_phi_unclustEnDown
        elif self.JECvar=="met_unclusteredUp":
            self.MET = event.MET_T1_pt_unclustEnUp
            self.MET_phi = event.MET_T1_phi_unclustEnUp
        
        met_tlv = TLorentzVector()
        met_tlv.SetPtEtaPhiM(self.MET,0.,self.MET_phi,0.)
        self.MET_px = met_tlv.Px()
        self.MET_py = met_tlv.Py()
        met = Object(event, "MET") #only CHS MET has covariance matrix
        self.MET_covXX = met.covXX
        self.MET_covXY = met.covXY
        self.MET_covYY = met.covYY
        ...
        if isMuTau or isETau:
            ...
            self.mysvinterface.setMetAndCovMat(self.MET_px,self.MET_py,self.MET_covXX,self.MET_covXY,self.MET_covXY,self.MET_covYY)
        ...
        self.m_col        = self.vis_mass/np.sqrt((self.vistau1_pt/(self.vistau1_pt+self.MET))*(self.vistau2_pt/(self.vistau2_pt+self.MET)))
        ...
        for i,jet in enumerate(jets):
            jet.pt   = eval("event.Jet_pt_nom[i]") #nominal value of jet pt (data and MC)
            jet.mass = eval("event.Jet_mass_nom[i]") #nominal value of jet mass (data and MC)
            if "jes" in self.JECvar:
                jet.pt   = eval("event.Jet_pt_%s[i]"%self.JECvar)
                jet.mass = eval("event.Jet_mass_%s[i]"%self.JECvar)
            elif self.JECvar=='jerDown':
                try:
                    jet.pt = event.Jet_pt_jerDown[i]
                    jet.mass = event.Jet_mass_jerDown[i]
                except:
                    jersplitId = getJERsplitID(jet.pt,jet.phi)
                    jet.pt = eval("event.Jet_pt_jer%sDown[%s]"%(jersplitId,i))
                    jet.mass = eval("event.Jet_mass_jer%sDown[%s]"%(jersplitId,i))
            elif self.JECvar=='jerUp':
                try:
                    jet.pt = event.Jet_pt_jerUp[i]
                    jet.mass = event.Jet_mass_jerUp[i]
                except:
                    jersplitId = getJERsplitID(jet.pt,jet.phi)
                    jet.pt = eval("event.Jet_pt_jer%sUp[%s]"%(jersplitId,i))
                    jet.mass = eval("event.Jet_mass_jer%sUp[%s]"%(jersplitId,i))
            if abs(jet.eta) < 2.4 and jet.pt > 20. and jet.jetId >= 2 and (jet.puId != 0 or jet.pt > 50.):
            ...
            elif abs(jet.eta) > 2.4 and jet.pt > 20. and jet.jetId >=2 and (jet.puId != 0 or jet.pt > 50.):
        ...
        if self.isMC:
         if "DY" in self.sample:
             ...
             self.wt_dy_up            = self.wt_dy * self.wt_dy
             self.wt_dy_down          = 1.
             self.wt_dy_ttxsecup      = self.MCCorrection.getWeight_btag(genV.Pt(),genV.M(),self.nBjets_m,"up")
             self.wt_dy_ttxsecdown    = self.MCCorrection.getWeight_btag(genV.Pt(),genV.M(),self.nBjets_m,"down")
             if self.nBjets_m==1:
                 self.wt_dy_1b_up         = self.wt_dy * self.wt_dy
                 self.wt_dy_1b_down       = 1.
                 self.wt_dy_1b_ttxsecup   = self.wt_dy_ttxsecup
                 self.wt_dy_1b_ttxsecdown = self.wt_dy_ttxsecdown
                 self.wt_dy_2b_up         = self.wt_dy #for 2b nominal value is used
                 self.wt_dy_2b_down       = self.wt_dy
                 self.wt_dy_2b_ttxsecup   = self.wt_dy
                 self.wt_dy_2b_ttxsecdown = self.wt_dy
             elif self.nBjets_m>=2:
                 self.wt_dy_2b_up         = self.wt_dy * self.wt_dy
                 self.wt_dy_2b_down       = 1.
                 self.wt_dy_2b_ttxsecup   = self.wt_dy_ttxsecup
                 self.wt_dy_2b_ttxsecdown = self.wt_dy_ttxsecdown
                 self.wt_dy_1b_up         = self.wt_dy #for 1b nominal value is used
                 self.wt_dy_1b_down       = self.wt_dy
                 self.wt_dy_1b_ttxsecup   = self.wt_dy
                 self.wt_dy_1b_ttxsecdown = self.wt_dy
        ...
        if "TT" in self.sample:
            ...
            self.wt_tt_pt = topPtWeight(event)
            self.wt_tt_pt_up = self.wt_tt_pt * self.wt_tt_pt
            self.wt_tt_pt_down = 1.
        ...
        if self.isMC:
            ...
            elif "Up" in self.JECvar:
                btag_unc = "up_"+self.JECvar[:-2]
                self.BTagWeight = self.btagTool.getWeight(jet_list,'shape',btag_unc,self.sample_name,isMuTau,isETau,self.isTTCR,self.isMuMu)
                self.BTagWeight_nocorr = self.btagTool.getWeight_nocorr(jet_list,'shape',btag_unc) #needed to derive the norm correction for shape SF
            elif "Down" in self.JECvar:
                btag_unc = "down_"+self.JECvar[:-4]
                self.BTagWeight = self.btagTool.getWeight(jet_list,'shape',btag_unc,self.sample_name,isMuTau,isETau,self.isTTCR,self.isMuMu)
                self.BTagWeight_nocorr = self.btagTool.getWeight_nocorr(jet_list,'shape',btag_unc) #needed to derive the norm correction for shape SF
            ...
            self.PUIdWeight = self.puidSF.getSF(event,jet_list,"nom")
            self.PUIdWeight_up = self.puidSF.getSF(event,jet_list,"up")
            self.PUIdWeight_down = self.puidSF.getSF(event,jet_list,"down")
        ...
        if len(jet_list) > 0:
            ...
            self.Jet1_nMuons = jet1.nMuons
            self.Jet1_nElectrons = jet1.nElectrons
            self.Jet1_nConstituents = jet1.nConstituents
        ...
        if len(jet_list) > 1:
            ...
            self.Jet2_nMuons = jet2.nMuons
            self.Jet2_nElectrons = jet2.nElectrons
            self.Jet2_nConstituents = jet2.nConstituents
        ...
        if len(jet_list) > 2:
            ...
            self.Jet3_nMuons = jet3.nMuons
            self.Jet3_nElectrons = jet3.nElectrons
            self.Jet3_nConstituents = jet3.nConstituents
            if self.isMC:
        ...
        if self.isTTCR:
            mu_tlv = self.tlv(pair[0])
            e_tlv = self.tlv(pair[1])
            self.Dzeta = Dzeta(mu_tlv,e_tlv,met_tlv,1.85)
        ...
        if isMuTau or isETau:
            ...
            self.mt = self.mass_t(lep_tlv,met_tlv)
            ...
            if self.isMC:
                met_up_tlv = TLorentzVector()
                met_up_tlv.SetPtEtaPhiM(event.MET_T1_pt_unclustEnUp,0.,event.MET_T1_phi_unclustEnUp,0.)
                met_down_tlv = TLorentzVector()
                met_down_tlv.SetPtEtaPhiM(event.MET_T1_pt_unclustEnDown,0.,event.MET_T1_phi_unclustEnDown,0.)
                self.mt_up = self.mass_t(lep_tlv,met_up_tlv)
                self.mt_down = self.mass_t(lep_tlv,met_down_tlv)
        ...
        if isMuTau:
            ...
            self.wt_ff_qcdfitpar0Up = wt_ff_list[2][0][0]
            self.wt_ff_qcdfitpar0Down = wt_ff_list[2][0][1]
            self.wt_ff_qcdfitpar1Up = wt_ff_list[2][0][2]
            self.wt_ff_qcdfitpar1Down = wt_ff_list[2][0][3]
            self.wt_ff_wfitpar0Up = wt_ff_list[2][1][0]
            self.wt_ff_wfitpar0Down = wt_ff_list[2][1][1]
            self.wt_ff_wfitpar1Up = wt_ff_list[2][1][2]
            self.wt_ff_wfitpar1Down = wt_ff_list[2][1][3]
            self.wt_ff_wfitpar2Up = wt_ff_list[2][1][4]
            self.wt_ff_wfitpar2Down = wt_ff_list[2][1][5]
            self.wt_ff_ttfitpar0Up = wt_ff_list[2][2][0]
            self.wt_ff_ttfitpar0Down = wt_ff_list[2][2][1]
            self.wt_ff_ttfitpar1Up = wt_ff_list[2][2][2]
            self.wt_ff_ttfitpar1Down = wt_ff_list[2][2][3]
            self.wt_ff_fracUp = wt_ff_list[3][0]
            self.wt_ff_fracDown = wt_ff_list[3][1]
            ...
            self.wt_ff_nocorr_flat = wt_ff_nocorr_list[3]
            ...
            self.wt_ff_qcd_flat = ffweight_sep[6]
            self.wt_ffcorr_hmass_qcd = self.ff.ffweightcorr_hmass(self.H_mass,self.Tau1_decaymode,"mutau",'qcd')
            self.wt_ffcorr_jetpt_qcd = self.ff.ffweightcorr_jetpt(self.Jet1_pt,self.Tau1_decaymode,"mutau",'qcd')
            self.wt_ffcorr_collinearmass_qcd = self.ff.ffweightcorr_collinearmass(self.collinear_mass,self.Tau1_decaymode,"mutau",'qcd')
            self.wt_ffcorr_taujmass_qcd = self.ff.ffweightcorr_taujmass(self.TauJ_mass,self.Tau1_decaymode,"mutau",'qcd')
            self.wt_ffcorr_hmass_tt = self.ff.ffweightcorr_hmass(self.H_mass,self.Tau1_decaymode,"mutau",'tt')
            self.wt_ffcorr_jetpt_tt = self.ff.ffweightcorr_jetpt(self.Jet1_pt,self.Tau1_decaymode,"mutau",'tt')
            self.wt_ffcorr_collinearmass_tt = self.ff.ffweightcorr_collinearmass(self.collinear_mass,self.Tau1_decaymode,"mutau",'tt')
            self.wt_ffcorr_taujmass_tt = self.ff.ffweightcorr_taujmass(self.TauJ_mass,self.Tau1_decaymode,"mutau",'tt')
            ...
            ff_fitunc = self.ffunc.ff_fitunc(self.Tau1_decaymode,"mutau",self.Tau1_pt)
            self.ff_fitunc_qcd_par0_up = ff_fitunc[0][0]
            self.ff_fitunc_qcd_par0_down = ff_fitunc[0][1]
            self.ff_fitunc_qcd_par1_up = ff_fitunc[0][2]
            self.ff_fitunc_qcd_par1_down = ff_fitunc[0][3]
            self.ff_fitunc_w_par0_up = ff_fitunc[1][0]
            self.ff_fitunc_w_par0_down = ff_fitunc[1][1]
            self.ff_fitunc_w_par1_up = ff_fitunc[1][2]
            self.ff_fitunc_w_par1_down = ff_fitunc[1][3]
            self.ff_fitunc_w_par2_up = ff_fitunc[1][4]
            self.ff_fitunc_w_par2_down = ff_fitunc[1][5]
            self.ff_fitunc_tt_par0_up = ff_fitunc[2][0]
            self.ff_fitunc_tt_par0_down = ff_fitunc[2][1]
            self.ff_fitunc_tt_par1_up = ff_fitunc[2][2]
            self.ff_fitunc_tt_par1_down = ff_fitunc[2][3]
        elif isETau:
            ...
            self.wt_ff_tt_old = ffweight_sep[5]
            self.wt_ff_qcd_flat = ffweight_sep[6]
            self.wt_ffcorr_hmass_qcd = self.ff.ffweightcorr_hmass(self.H_mass,self.Tau1_decaymode,"etau",'qcd')
            self.wt_ffcorr_jetpt_qcd = self.ff.ffweightcorr_jetpt(self.Jet1_pt,self.Tau1_decaymode,"etau",'qcd')
            self.wt_ffcorr_collinearmass_qcd = self.ff.ffweightcorr_collinearmass(self.collinear_mass,self.Tau1_decaymode,"etau",'qcd')
            self.wt_ffcorr_taujmass_qcd = self.ff.ffweightcorr_taujmass(self.TauJ_mass,self.Tau1_decaymode,"etau",'qcd')
            self.wt_ffcorr_hmass_tt = self.ff.ffweightcorr_hmass(self.H_mass,self.Tau1_decaymode,"etau",'tt')
            self.wt_ffcorr_jetpt_tt = self.ff.ffweightcorr_jetpt(self.Jet1_pt,self.Tau1_decaymode,"etau",'tt')
            self.wt_ffcorr_collinearmass_tt = self.ff.ffweightcorr_collinearmass(self.collinear_mass,self.Tau1_decaymode,"etau",'tt')
            self.wt_ffcorr_taujmass_tt = self.ff.ffweightcorr_taujmass(self.TauJ_mass,self.Tau1_decaymode,"etau",'tt')
            ffuncertainties = self.ffunc.ffuncertainty(self.Tau1_pt,self.Tau1_decaymode,"etau")
            self.ffunc_qcd = ffuncertainties[0]
            self.ffunc_w = ffuncertainties[1]
            self.ffunc_tt = ffuncertainties[2]
            ff_fitunc = self.ffunc.ff_fitunc(self.Tau1_decaymode,"etau",self.Tau1_pt)
            self.ff_fitunc_qcd_par0_up = ff_fitunc[0][0]
            self.ff_fitunc_qcd_par0_down = ff_fitunc[0][1]
            self.ff_fitunc_qcd_par1_up = ff_fitunc[0][2]
            self.ff_fitunc_qcd_par1_down = ff_fitunc[0][3]
