...
parser.add_argument('-T', '--tes',      dest='tes', action='store', choices=["","scale_t_1prongUp","scale_t_1prong1piUp","scale_t_3prongUp","scale_t_1prongDown","scale_t_1prong1piDown","scale_t_3prongDown"], type=str, default="")
...
if year == 2016:
    ...
    if dataType=='data':
        filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/SingleElectron/SingleElectron_Run2017C-UL2017_MiniAODv2_NanoAODv9-v1__UL2017/230707_091202/0000/tree_13.root']
    else:
        filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8__UL2017/230707_091201/0000/tree_4.root']
    ...
    if dataType=='data':
        ...
        #filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_skim//UL2018/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/tree_118.root']
        filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/WplusHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8/WplusHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8__UL2018/230919_161617/0000/tree_3.root']
        #filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/DYJetsToLL_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8/DYJetsToLL_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8__UL2018/210923_210444/0000/tree_7.root']
        ...
        #filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/samples_skim/UL2018_JEC/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/tree_7.root']
        #filelist = ['/pnfs/psi.ch/cms/trivcat/store/user/pbaertsc/bbh/bbHToTauTau_M-125_4FS_TuneCP5_yb2_13TeV-amcatnlo-pythia8/bbHToTauTau_M-125_4FS_TuneCP5_yb2_13TeV-amcatnlo-pythia8__UL2018/220201_163706/0000/tree_7.root']
infiles = filelist
